...
" License:      Beer Ware
" Original:     https://github.com/hukl/Smyck-Color-Scheme/blob/master/smyck.vim
" ----------------------------------------------------------------------------
...
hi NonText         cterm=bold    ctermbg=none    ctermfg=8       gui=bold    guibg=#333333    guifg=#8F8F8F
...
hi Todo            cterm=none    ctermbg=14      ctermfg=0       gui=none    guifg=#00aa55    guibg=#ffff00

" ----------------------------------------------------------------------------
" Syntax Highlighting
" ----------------------------------------------------------------------------
hi Keyword          cterm=none    ctermbg=none    ctermfg=10         gui=none         guifg=#D1FA71
hi Comment          cterm=none    ctermbg=none    ctermfg=8          gui=none,italic  guifg=#AFAFAF
